...
print(f"Successfully loaded gridded version: {gridded.__version__}")
...
# model urls:
models = dict(
    ADCIRC="http://comt.sura.org/thredds/dodsC/data/comt_1_archive/inundation_tropical/UND_ADCIRC/Hurricane_Rita_2D_final_run_without_waves",
...
def make_map(projection=ccrs.PlateCarree()):
    fig, ax = plt.subplots(figsize=(16, 6), subplot_kw=dict(projection=projection))
...
title = ax.set_title("{}\n{}\n{}".format(variable, time_string, ssh.attributes["standard_name"]))
