...
def test_add_attributes():
    d = UVar("depth", location="node", data=[1.0, 2.0, 3.0, 4.0])
    d.attributes = {"standard_name": "sea_floor_depth_below_geoid", "units": "m", "positive": "down"}
...
def test_nc_variable():
    ...
    with chdir(test_files):
        ...
        assert uvar.attributes == {"attr_1": "some value", "attr_2": "another value"}
        # access the data
