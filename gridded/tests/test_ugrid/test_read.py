...
from gridded.pyugrid import read_netcdf, ugrid
...
def test_read_boundaries():
    ...
    expected_boundaries = [[0, 1], [1, 2], [2, 3], [3, 4], [4, 0], [5, 6], [6, 7], [7, 8], [8, 5]]
...
def test_read_data_keys():
    ...
    assert sorted(grid.data.keys()) == ["boundary_count", "boundary_types", "depth"]
