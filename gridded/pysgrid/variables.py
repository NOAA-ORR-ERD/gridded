...
from gridded.pysgrid.utils import determine_variable_slicing, infer_avg_axes, infer_variable_location
...
class SGridVariable:
    ...
    def create_variable(cls, nc_var_obj, sgrid_obj):
        ...
        center_slicing = determine_variable_slicing(sgrid_obj, nc_var_obj, method="center")
    ...
    def __str__(self):
        return f"SGridVariable object: {self.standard_name:s}, on the {self.location:s}s"
